...
class CirclePainter extends CustomPainter {
  ...
  Paint _paint1;
  double _startAngle;
  CirclePainter(this.colors,this.percent,{ this.filled=false, this.strokeWidth=15.0,double startAngle=pi/2,this.center=const Offset(150.0,150.0),this.radius=100}){
